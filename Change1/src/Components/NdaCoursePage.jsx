...
import scrollCardImg from "../Images/Cover-Photo.png"
import AppFeatures from "./AppFeatures"
import NdaCourseDetailSection from "./NdaCourseDetailSection";
import DVAPP from "./DVApp"
export default function NdaCoursePage() {
  useEffect(() => {
