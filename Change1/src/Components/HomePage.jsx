...
import dfImg1 from "../Images/ndaExamCoaching.jpeg"
import dfImg2 from "../Images/democds1.png"
import dfImg3 from "../Images/cdsotabrochure.png"
import dfImg4 from "../Images/afcatbrochure.png"
import afcatImg from "../Images/afcatimg.jpg"
import ots from "../brochure/ota.pdf"
import AppFeatures from './AppFeatures'
import EBookSection from './EBookSection'
import StartPrepration from './StartPrepration'
import testSectionImage from "../Images/testSectionImage.jpeg"
import ScaleCardSection from './ScaleCardSection'
import AcheiveMore from './AcheiveMore'
import UpcomingSeminar from './UpcomingSeminar'
import BlogsSection from './BlogsSection'
import DVApp from './DVApp'
import WritingExamSection from './WritingExamSection'
    ...
    <>
      ...
      <div className="brochure-section">
        <div className="brochure-card">
          <img src={dfImg1} alt="" />
          <h4>NDA</h4>
          <p>Joint our most awaited and self paced course for NDA and prepare yourself for the academy</p>
        ...
        <div className="brochure-card">
          <img src={dfImg2} alt="" />
          <h4>CDS</h4>
          <p>Join our most awaited and self paced course for CDS and prepare yourself for the academy</p>
        ...
        <div className="brochure-card">
          <img src={dfImg4} alt="" />
          <h4>AFCAT</h4>
          <p>Join our most awaited and self paced course for AFCAT and prepare yourself for the academy</p>
        ...
        <div className="brochure-card">
          <img src={dfImg3} alt="" />
          <h4>CDS OTA</h4>
          <p>Join our most awaited and self paced course for CDS OTA and prepare yourself for the academy</p>
          <Link to={"cds-course"} className="btn-a-solid">More Details</Link>
      ...
      <div className="test-section">
        <h3>Defence Vidya Tests</h3>
        <Link to="/test-series" ><img src={testSectionImage} alt="" /></Link>
      </div>
